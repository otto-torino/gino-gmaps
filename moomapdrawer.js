...
provides: [moomapdrawer.map, moomapdrawer.tool, moomapdrawer.pointTool, moomapdrawer.polylineTool, moomapdrawer.polygonTool, moomapdrawer,circleTool]
...
moomapdrawer.map = (function()  {
	...
	return new Class({
		...
		initialize: function(canvas, options) {
            ...
            _private[this.id].container = new Element('div.gmapdraw_container')
                .setStyle('position', 'relative')
                .wraps(_private[this.id].canvas);
		...
		addControllersContainer: function() {
			...
			_private[this.id].ctrl_container.inject(_private[this.id].container, 'top').setStyles({
