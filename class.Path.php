...
/**
 * @file class.Path.php
 * @brief Contiene la definizione ed implementazione della classe Gino.App.Gmaps.Path
 *
...
/**
 * @brief Classe di tipo Gino.Model che rappresenta un percorso
 *
 * @version 0.1.0
 * @copyright 2015 Otto srl MIT License http://www.opensource.org/licenses/mit-license.php
 * @author marco guidotti <marco.guidotti@otto.to.it>
 * @author abidibo <abidibo@gmail.com>
 */
class Path extends \Gino\Model
{
    public static $table = 'gmaps_path',
                  $table_categories = 'gmaps_path_category',
                  $table_points = 'gmaps_path_point';
     ...
     * @return istanza di Gino.App.Gmaps.Path
     */
    public function __construct($id, $instance)
    {
        ...
        $this->_fields_label = array(
            ...
            'lat' => _('Latitudine'),
            'lng' => _('Longitudine'),
            'color' => array(_('Colore tracciato'), _('Utilizzare un formato css valido')),
    ...
    {
        return $this->_registry->router->link($this->_controller->getInstanceName(), 'path', array('id' => $this->slug));
    }
